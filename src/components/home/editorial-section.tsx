...
export function EditorialSection({
  ...
  return (
    <section className="bg-nexus-mist py-20">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2">
        ...
        <Reveal className={imageFirst ? "lg:order-2" : "lg:order-1"} delay={0.1}>
          ...
          <h2 className="mt-3 tracking-tight text-3xl font-bold leading-tight text-nexus-ink sm:text-4xl">
            {heading}
          </h2>
          ...
          <div className="mt-8 space-y-4">
            {highlights.map((h) => (
              ...
              >
                <h3 className="font-bold text-nexus-navy">{h.title}</h3>
